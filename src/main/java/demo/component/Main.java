...
import demo.component.car.CarApplication;
import demo.component.caruifactory.CarFactory;
import demo.component.caruifactory.NexonCarFactory;
import demo.component.caruifactory.TataCarFactory;
...
public class Main {
    public static void main(String[] args) {
       ...
       // application.paint();
        ...
        // car Example
        CarApplication carApplication = new CarApplication(new NexonCarFactory());
        carApplication.make();

        CarApplication carApplication1 = new CarApplication(new TataCarFactory());
        carApplication1.make();
